...
// Arcane-FX
//    Changes:
//        core -- inserted calls to arcaneFX::init() and arcaneFX::shutdown().
...
// AFX CODE BLOCK (core) <<
// Required calls to arcaneFX::init() and arcaneFX::shutdown() for proper
...
//   Memory::setBreakAlloc(104717);
   ...
   //TGE Modernization Kit: DARREN MOD. must create after window is created
   MK::create();
   //TGE Modernization Kit
